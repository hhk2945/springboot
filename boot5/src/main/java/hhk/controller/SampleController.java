...
public class SampleController {
	...
	public void sample2(Model model) {
		...
		MemberVO vo = 
				new MemberVO(123, "u00","p00","hhk", new Timestamp(System.currentTimeMillis()));
	...
	public void sample3(Model model) {
		...
		for(int i=0; i<10; i++) {
			list.add(new MemberVO(123, "u0"+i,"p0"+i, "hhk"+i,
	...
	public void sample4(Model model) {
		...
		for(int i=0; i<10; i++) {
			list.add(new MemberVO(i, "u000"+i%3,"p0000"+i%3, "hhk"+i,
					new Timestamp(System.currentTimeMillis())));
		}
